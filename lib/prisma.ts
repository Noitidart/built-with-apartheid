...
export function withPrisma(
  handler: (prisma: PrismaClient, req: NextApiRequest, res: NextApiResponse) => Promise<void>
) {
  return async function wrappedApiHandler(req: NextApiRequest, res: NextApiResponse): Promise<void> {
