...
export function hasFormError<
  UResponseData extends Partial<TResponseDataWithErrors>
>(errorKey: string, responseData?: UResponseData): boolean {
...
export function hasAnyFormError<
  UResponseData extends Partial<TResponseDataWithErrors>
>(responseData?: UResponseData): boolean {
  if (!responseData || !responseData._errors) {
    return false;
  }
