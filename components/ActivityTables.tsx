...
function StatsDisplay({
  ...
  return (
    ...
    >
      <div className="text-center space-x-2 text-xl font-bold flex flex-col md:flex-row items-center justify-center bg-gradient-to-r from-indigo-400 to-purple-700 bg-clip-text text-transparent animate-gradient-sweep">
